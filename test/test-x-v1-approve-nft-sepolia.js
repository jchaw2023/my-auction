async function main() {
    ...
    // 检查网络
       ...
       const balance = await myNFTContract.balanceOf(signerAddress);

       if (balance.toString() === "0") {
           console.log("❌ 没有找到 NFT，无法创建拍卖");
           process.exit(1);
       }
       console.log(`NFT Balance: ${balance.toString()}`);
       console.log(await myNFTContract.tokenURI(2));
       await myXAuction.approveNFT(myNFT.address, 2);
       console.log(await myNFTContract.isApprovedForAll(signerAddress, myXAuctionAddress));
