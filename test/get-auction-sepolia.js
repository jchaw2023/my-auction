 ...
 * 
 * 使用方法：
 * AUCTION_ID=0 npx hardhat run test/get-auction-sepolia.js --network sepolia
 * 
 * Windows:
 * set AUCTION_ID=0 && npx hardhat run test/get-auction-sepolia.js --network sepolia
 */
async function main() {
  // 检查网络
  if (network.name !== "sepolia") {
    console.error("❌ 此脚本只能在 Sepolia 测试网上运行");
    console.log("请使用: npx hardhat run test/get-auction-sepolia.js --network sepolia");
    process.exit(1);
  }
